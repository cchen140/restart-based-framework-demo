 ...
 */
//#define TEST_ADDRESS		0x00090000 //0x1000000
#define TEST_ADDRESS		0x0F00000 //0x1000000
#define UNIQUE_VALUE		0x17
/*
...
u8 RotSecureMemoryReadTestByte() {
	FlashRead(&QspiInstance, TEST_ADDRESS, 1, READ_CMD);
...
int RotSecureMemoryUpdateTestByte(u8 inVal) {
	 ...
	 */
	WriteBuffer[DATA_OFFSET] = inVal;
	FlashWrite(&QspiInstance, TEST_ADDRESS, 1, WRITE_CMD);
	return XST_SUCCESS;
}

void RotSecureMemoryClose(void) {
	QspiDisableIntrSystem(&IntcInstance, QSPI_INTR_ID);
}
